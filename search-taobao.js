...
async function main() {
  ...
  const result = await searchRepo('taobao+spider+OR+taobao+商品+爬虫+OR+tianmao+spider');
  ...
  console.log('=== 搜索京东商品爬虫 ===');
  const result2 = await searchRepo('jd+spider+OR+京东+爬虫+OR+jingdong+spider');
